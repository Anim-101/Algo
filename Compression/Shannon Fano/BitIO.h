...
/*
Here for functions get_nbits() and put_nbits()
INT_BIT is the number of bits in an integer hence
sizeof(int)*8,(16,32,64,...)
By using these functions,we can 'get' and 'put' at most
INT_BIT number of bits.
*/
