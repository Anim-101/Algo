...
int main(int argc,char *argv[])
{
    ...
    if(argc!=3)
    {
        fprintf(stderr,"\nA Base 256 Shanon Fano Algorithm Implementation");
        fprintf(stderr,"\nUsage:Shanon Fano Provide Input File name and Out put File Name");
        copyRight();
        return 0;
    }
