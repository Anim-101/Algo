...
int main(int argc,char *argv[])
{
    ...
    fprintf(stderr,"\nA Lempel Ziv 77 and Adaptive Huffman Vitter Algorithm's DeCompressor");
    ...
    fprintf(stderr,"\nTime Took to DeCompress That File Using Lempel Ziv 77 and Adaptive Huffman Based on Vitter Algorithm %lf Seconds\n",timeTook);
