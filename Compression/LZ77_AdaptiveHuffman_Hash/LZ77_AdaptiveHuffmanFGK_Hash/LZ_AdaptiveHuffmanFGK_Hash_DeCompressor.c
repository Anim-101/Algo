...
int main(int argc,char *argv[])
{
    ...
    if(argc!=3)
    {
        fprintf(stderr,"Basic Lempel Ziv 77 And Adaptive Huffman Based on FGK Algorithm with 3 Byte Hash Implementation");
    ...
    fprintf(stderr,"\nTime Took to DeCompress That File Using Lempel Ziv 77 and Adaptive Huffman Based on FGK Algorithm with 3 Byte Hash   :%lf Seconds\n",timeTook);
