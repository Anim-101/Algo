...
int main(int argc,char *argv[])
{
    ...
    if(argc!=3)
    {
        fprintf(stderr,"Basic Lempel Ziv 77 And Adaptive Huffman Based on Vitter Algorithm's with 3 Byte Hash Implementation");
    ...
    fprintf(stderr,"\nCompressing Using Lempel Ziv 77 and Adaptive Huffman Based on Vitter Algorithm with 3 Byte Hash");
    ...
    fprintf(stderr,"\nTime Took to Compress Using Lempel Ziv 77 and Adaptive Huffman Based on Vitter Algorithm with 3 Byte Hash     = %lf Seconds\n",timeTook);
