...
int main(int argc,char *argv[])
{
    ...
    fprintf(stderr,"\nA Lempel Ziv 77 and Adaptive Huffman FGK Algorithm's Compressor");
    ...
    fprintf(stderr,"\nCompressing Using Lempel Ziv 77 and Adaptive Huffman Based on FGK Algorithm");
    ...
    fprintf(stderr,"\nTime Took to Compress That File Using Lempel Ziv 77 and Adaptive Huffman Based on FGK Algorithm = %lf Seconds\n",timeTook);
